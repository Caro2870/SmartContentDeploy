  ...
  export default {
    mounted() {
      ...
      script.onload = () => {
        ...
        google.accounts.id.renderButton(
          ...
          { theme: "filled_blue", size: "large", shape: "rectangular", type: "standard", text: "signup_with", logo_alignment: "left" } // customization attributes
        );
    ...
    methods: {
      async handleCredentialResponse(response) {
        const data = await AuthenticationService.signupGoogle(response)
