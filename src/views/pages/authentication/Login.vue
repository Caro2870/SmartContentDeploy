      ...
      >
        ...
        >
          ...
          <b-card-text class="mb-2">
            Please sign-in to your account and get ready to take your content to another level!          
          </b-card-text>
...
import GoogleLoginButton from '@/views/pages/authentication/buttons/GoogleLoginButton.vue';
